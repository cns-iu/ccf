...
export const NAVIGATION_ITEMS: NavItems[] = [
  {
    ...
    children: [
      ...
      {
        menuName:
          'Anatomical Structures, Cell Types + Biomarkers (ASCT+B) Tables',
        route: 'asctb-tables',
        disabled: true,
      },
      {
        menuName:
          'Anatomical Structures, Cell Types + Biomarkers (ASCT+B) Cell Types Data from Azimuth',
        route: 'asctb-azimuth',
        disabled: true,
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        menuName:
          'Anatomical Structures, Cell Types + Biomarkers (ASCT+B) Reporter',
